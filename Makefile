...
ems: main.c main.h constants.h linkedList.c linkedList.h linkedList.o operations.o parser.o eventlist.o
	$(CC) $(CFLAGS) $(SLEEP) -o ems main.c operations.o parser.o eventlist.o linkedList.o
